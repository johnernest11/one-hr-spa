...
import ItemNumberPage from '@/views/humanresources/ItemNumberPage.vue'
    ...
    children: [
      {
        ...
        component: () => import('@/views/humanresources/PPMSDashboardPage.vue'),
        meta: <RouteMeta>{
          label: 'Dashboard',
          isSidebarMenu: true,
          authType: AuthType.AUTHENTICATED,
      ...
      },
      {
        path: 'employment/:id?',
        name: 'employment',
        component: () => import('@/views/humanresources/EmployeesPage.vue'),
        meta: <RouteMeta>{
          label: 'Employment',
          isSidebarMenu: true,
          authType: AuthType.AUTHENTICATED,
    ...
    children: [
      {
        ...
        component: () => import('@/views/humanresources/PASDashboardPage.vue'),
        meta: <RouteMeta>{
          label: 'Dashboard',
          isSidebarMenu: true,
          authType: AuthType.AUTHENTICATED,
      ...
      },
      {
        ...
        component: () => import('@/views/humanresources/DTRPage.vue'),
        meta: <RouteMeta>{
          label: 'Daily Time Record',
          isSidebarMenu: true,
          authType: AuthType.AUTHENTICATED,
      ...
      },
      {
        ...
        component: () => import('@/views/humanresources/LeaveFilePage.vue'),
        meta: <RouteMeta>{
          label: 'Leave Application',
          isSidebarMenu: true,
          authType: AuthType.AUTHENTICATED,
      ...
      },
      {
        path: '/payrolls/:id?',
        name: 'payrolls',
        component: () => import('@/views/humanresources/PayrollPage.vue'),
        meta: <RouteMeta>{
          label: 'Payroll',
          isSidebarMenu: true,
          authType: AuthType.AUTHENTICATED,
      ...
      },
      {
        path: '/staff-ctdos/:id?',
        name: 'staff-ctdos',
        component: () => import('@/views/humanresources/CTDOPage.vue'),
        meta: <RouteMeta>{
          label: 'Staff CTDO`s',
          isSidebarMenu: true,
          authType: AuthType.AUTHENTICATED,
      ...
      },
      {
        path: '/staff-cocs/:id?',
        name: 'staff-cocs',
        component: () => import('@/views/humanresources/COCPage.vue'),
        meta: <RouteMeta>{
          label: 'Staff COC`s',
          isSidebarMenu: true,
          authType: AuthType.AUTHENTICATED,
