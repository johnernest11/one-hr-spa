                ...
                >
                  <template #body="props">
                    ...
                    <template v-else-if="props.data.status === 'Review'">
                      <Chip
                        label="For Review"
                        class="flex items-center justify-center bg-success-500 px-4 py-1 font-semibold text-surface-0"
                      />
                    </template>
                    <template v-else-if="props.data.status === 'Approved'">
                      <Chip
                        label="Approved"
                        class="flex items-center justify-center bg-info-700 px-4 py-1 font-semibold text-surface-0"
                      />
                    </template>
                  </template>
                </Column>
