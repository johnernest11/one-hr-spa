...
import { calcDurationMins, extractMonthYear, extractMonthYearPlusOneYear, fmtHoursMins } from '@/utils/helpers'
...
// Fetch Data Based on Route Context
onBeforeMount(async () => {
...
// Calculate Total Duration in Minutes from all time entries
        ...
        <div class="flex w-full items-center justify-end gap-4">
          <div class="flex space-x-2 whitespace-nowrap md:w-auto">
            <Button
              ...
              v-tooltip.top="'Filter Compensatory Overtime Credits'"
              severity="info"
              size="large"
        ...
        <div class="w-full">
          <div class="overflow-x-auto">
            <DataTable :value="compensatoryDayTimeOffStore.compensatory" class="mt-6" dataKey="id">
              ...
              >
                <template #body="props">
                  <p class="font-semibold uppercase text-surface-600">{{ extractMonthYear(props.data.ctdo_period) }}</p>
                </template>
              </Column>
              <Column
                field="edited_at"
              ...
              >
                <template #body="props">
                  <p class="uppercase text-surface-600">{{ fmtHoursMins(calcTotalDurationMins(props.data.rows ?? [])) }}</p>
                </template>
              </Column>
              <Column
                field="edited_at"
              ...
              >
                <template #body="props">
                  <p class="uppercase text-surface-600">{{ extractMonthYearPlusOneYear(props.data.ctdo_period) }}</p>
                </template>
              </Column>
