        ...
        <div id="dtr_table" class="relative">
          ...
          <div v-else-if="!isLoading">
            ...
            <div
              ...
              class="grid cursor-pointer grid-cols-1 items-center gap-y-2 border-b border-surface-300 px-4 py-4 transition-all duration-150 hover:bg-surface-100 dark:hover:bg-primary-950 md:grid-cols-12 md:gap-2 md:px-24"
            >
              <div>
